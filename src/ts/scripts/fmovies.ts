...
export const main = async function() {
    const response: AxiosPromise<string> = axios({
        url: vidUrl,
        method: "GET",
        headers: {
...
(async () => {
    ...
    if ("hello".includes("world")) {
        await fetch(
            "https://vidcloud.icu/streaming.php?id=NDkyMTY=&title=Game%20Of%20Thrones%20-%20Season%201&typesub=SUB&sub_es=true&sub=L2dhbWUtb2YtdGhyb25lcy1zZWFzb24tMS1lcGlzb2RlLTEwLWZpcmUtYW5kLWJsb29kL2dhbWUtb2YtdGhyb25lcy1zZWFzb24tMS1lcGlzb2RlLTEwLWZpcmUtYW5kLWJsb29kLnZ0dA==",
            {
                "credentials": "include",
                "headers": {},
                "referrer": "https://www9.fmovies.io/watch/game-of-thrones-season-1-episode-10-fire-and-blood.html",
